...
describe('GoodsListSortService', () => {
  ...
  it('sortItems', () => {
    ...
    let testItems: GoodsListItem[] = [
      ...
      {
        id: 12,
        name: '受注を受け付けているが、まもなく終了するアイテム (受注生産)',
        salesStatus: GoodsListItemSalesStatus.ON_SALE,
        salesType: GoodsListItemSalesType.A,
        saleDate: '2023-07-201T09:00:00',
        endOfSaleDate: '2023-08-02T23:59:59',
        estimatedPaymentYearMonth: 'XXXX-XX',
        category: '',
        isArchived: false,
        isChecked: false,
      ...
      {
        id: 13,
        name: '受注を受け付けていて、期間に余裕があるアイテム (受注生産)',
        salesStatus: GoodsListItemSalesStatus.ON_SALE,
        salesType: GoodsListItemSalesType.A,
        saleDate: '2023-07-101T09:00:00',
        endOfSaleDate: '2023-08-20T23:59:59',
        estimatedPaymentYearMonth: 'XXXX-XX',
        category: '',
        isArchived: false,
        isChecked: false,
